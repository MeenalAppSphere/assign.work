  ...
  ngOnInit(): void {
      ...
      this.projectList = [
        ...
        },
        {
          ...
          "status": "Ready",
          "tasks": "56",
          "desc": "Efficiently unleash cross-media information without cross-media value.",
          "progress": 100,
          "member": [
            {
        ...
        },
        {
          ...
          "status": "In Progress",
          "tasks": "38",
          "desc": "Irish skinny, grinder affogato, dark, sweet carajillo flavour seasonal.",
          "progress": 73,
          "member": [
            {
        ...
        },
        {
          ...
          "status": "In Progress",
          "tasks": "68",
          "desc": "Here's the story of a man named Brady who was busy with three boys",
          "progress": 62,
          "member": [
            {
              "avatar": "assets/images/avatars/thumb-4.jpg",
